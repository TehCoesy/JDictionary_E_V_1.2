...
public class Dictionary {
    ...
    public static void addS(String word_target, String word_explain) {
        word_list.add(new Word(word_target,word_explain));
    }
    ...
    public String getWordS(int index) {
        ...
        String output = String.format("%15s | %15s",get.getTarget(),get.getExplain());
        return output;
    }
}
